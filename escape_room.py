# -*- coding: utf-8 -*-
"""Escape room Team2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1giCrp5ZSU6kpwIEwWGXIsR8_25UgKrCI
"""
...
# Day 2:Develop functions for game actions, like room navigation, item usage, etc.
...
def play_room(room):
    ...
    # display to user current room and ask for action
        ...
        if intended_action == "1":
            ...
            examine_item(input(f"What would you like to examine in {room['name']}?").strip())
        else:
